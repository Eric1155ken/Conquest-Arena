...
public class attack : MonoBehaviourPun
{
    ...
    void Shoot()
    {
        ...
        if (attackMode == 1)
        {
            newProjectile = PhotonNetwork.Instantiate("projectilePrefab", transform.position, Quaternion.identity);
        ...
        {
            newProjectile = PhotonNetwork.Instantiate("projectilePrefab2", transform.position, Quaternion.identity);
