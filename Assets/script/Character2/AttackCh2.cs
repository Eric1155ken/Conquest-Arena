...
public class AttackCh2 : MonoBehaviourPun
{
    ...
    void Shoot()
    {
        ...
        if (attackMode == 1)
        {
            newProjectile = PhotonNetwork.Instantiate("projectile1Ch2", transform.position, Quaternion.identity);
        ...
        {
            newProjectile = PhotonNetwork.Instantiate("projectile2Ch2", transform.position, Quaternion.identity);
