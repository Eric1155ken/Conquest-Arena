...
public class AttackCh4 : MonoBehaviourPun
{
            ...
            if (Physics.Raycast(ray, out RaycastHit hit, Mathf.Infinity, LayerMask.GetMask("Map")))
            {
                ...
                else if (attackMode == 2 && !isCooldown2)
                {
                    if (myCharacterStamina.currentStamina >= staminaCost2)
                    {
                        ...
                        PhotonNetwork.Instantiate("Hit_04", transform.position, Quaternion.identity);
    ...
    void Shoot()
    {
        ...
        if (attackMode == 1)
        {
            newProjectile = PhotonNetwork.Instantiate("projectile1Ch4", transform.position, Quaternion.identity);
        ...
        else if (attackMode == 2)
        {
            ...
            newProjectile = PhotonNetwork.Instantiate("projectile2Ch4", transform.position, Quaternion.identity);
